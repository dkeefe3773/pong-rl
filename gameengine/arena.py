...
from gameengine.gameactors import StationaryPolygon, Paddle, Actor
...
class Arena:
    def __init__(self, arena_width: int, arena_height: int, line_thickness: int,
        ...
        self.actors = actors
        self.all_actors = [self.top_bound, self.bottom_bound, self.center_net, self.paddles[0], self.paddles[1]]
